...
import torch
import math
from gaussiansplat_rasterization import GaussianRasterizationSettings, GaussianRasterizer
...
def render(viewpoint_camera, pc : GaussianModel, pipe, bg_color : torch.Tensor, opt, scaling_modifier = 1.0, override_color = None):
    ...
    raster_settings = GaussianRasterizationSettings(
        ...
        prefiltered=False,
        debug=pipe.debug,
        include_feature=True, #opt.train_feature_only
    )
    ...
    return {"render": rendered_image,
            ...
            'language_feature_3dprecomp': language_feature_precomp,
