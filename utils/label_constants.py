...
REPLICA_LABELS_24 = ('bin', 'blinds', 'camera', 'chair', 'clock', 'ceiling', 'desk-organizer', 'door', 'floor', 'indoor-plant', 'lamp', 'panel', 'pillar', 'plant-stand', 'sofa', 'switch', 'table', 'tablet', 'tissue-paper', 'tv-screen', 'vent', 'wall', 'wall-plug', 'rug','other')
...
REPLICA_LABELS_52= ('other', 'basket', 'bed', 'bench', 'bin', 'blanket', 'blinds', 'book', 'bottle', 'box', 'bowl', 'camera', 'cabinet', 'candle', 'chair', 
                    'clock', 'cloth', 'comforter', 'cushion', 'ceiling', 'desk', 'desk-organizer', 'door', 'floor', 'indoor-plant', 'lamp', 'monitor', 'nightstand', 
                    'panel', 'picture', 'pillar', 'pillow', 'pipe', 'plant-stand', 'plate', 'pot', 'sculpture', 'shelf', 'sofa', 'stool', 'switch', 'table', 'tablet', 
                    'tissue-paper', 'tv-screen', 'tv-stand', 'vase', 'vent', 'wall', 'wall-plug', 'window', 'rug')
